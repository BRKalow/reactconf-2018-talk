...
<ul>
  <Appear>
    ...
    <div><span style={{ transform: 'rotate(45deg) perspective(0)', display: 'block', position: 'absolute', top: '50%', right: '30%', fontSize: '5em' }}>😅</span></div>
  </Appear>
</ul>
...
```notes
It's another way to organize our code, 
```
...
then use them to compose logic just like we do our UI
```
...
<https://component-units-of-work.now.sh>
